    ...
    !(function (e) {
      ...
      (function (e) {
        function t(e, t) {
          if (!e.originalErr)
            for (
              var r = (e.stack || e.message || e).toString().split("\n"),
                n = [],
                a = 0;
              a < r.length;
              a++
          ...
          return (
            F ? (i.stack = null) : (i.stack = o),
            (i.originalErr = e.originalErr || e),
            i
          );
        }
        function r() {}
        ...
        function c(e, t) {
          ...
          return new X(e, (t && t.replace(/#/g, "%05")) || Q).href.replace(
            /%05/g,
            "#"
          );
        }
        ...
        function p(t) {
          ...
          if (("object" == typeof t || "function" == typeof t) && t !== e)
            if (ee) for (var n in t) "default" !== n && h(r, t, n);
            else g(r, t);
        ...
        function b(e, t, r, n, a) {
          for (var o in t)
            if (
              -1 !=
              U.call(["main", "format", "defaultExtension", "basePath"], o)
            )
              e[o] = t[o];
        ...
        function P(e, t) {
          ...
          if ("@node/" == e.substr(0, 6)) {
            ...
            return (
              this.set(
                e,
                this.newModule(p(j.call(this, e.substr(6), this.baseURL)))
              ),
              e
            );
          }
        ...
        function k(e, t, r) {
          re.browser && t.browserConfig && r(t.browserConfig),
            re.node && t.nodeConfig && r(t.nodeConfig),
            re.dev && t.devConfig && r(t.devConfig),
            re.build && t.buildConfig && r(t.buildConfig),
            re.production && t.productionConfig && r(t.productionConfig);
        }
        function O(e) {
          var t = e.match(ie);
          ...
          return this.normalize(e.module, t).then(function (t) {
            return n.load(t).then(function (a) {
              ...
              if (r && "boolean" != typeof o)
                throw new TypeError(
                  "Condition " + I(e) + " did not resolve to a boolean."
                );
              return e.negate ? !o : o;
            });
          });
        ...
        if ("undefined" != typeof document && document.getElementsByTagName) {
          if (((J = document.baseURI), !J)) {
            ...
            J = ($[0] && $[0].href) || window.location.href;
          }
        ...
        !(function () {
          function r(e, t) {
            ...
            return (
              ...
              ("\n//# sourceURL=" != e.source.substr(r, 15)
                ? "\n//# sourceURL=" + e.address + (n ? "!transpiled" : "")
                : "") +
              ((n &&
                l &&
          ...
          function o(e) {
            h ||
              (h = document.head || document.body || document.documentElement);
            ...
            if (
              ...
              e.metadata.integrity &&
                o.setAttribute("integrity", e.metadata.integrity),
              e.metadata.nonce && o.setAttribute("nonce", e.metadata.nonce),
              h.appendChild(o),
              h.removeChild(o),
              a(),
              (window.onerror = s),
          ...
          te = function (e) {
            if (e.source) {
              if ((e.metadata.integrity || e.metadata.nonce) && m)
                return o.call(this, e);
              try {
                n(this, e),
                  (s = e),
                  this._nodeRequire && !f
                    ? ((d = d || this._nodeRequire("vm")),
                      d.runInThisContext(r(e, !0), {
                        filename:
                          e.address +
        ...
        (a.prototype.config = function (e, t) {
          ...
          if (
            ...
            ("production" in e || "build" in e) &&
              _.call(n, !!e.production, !!(e.build || (re && re.build))),
            !t)
          ) {
            var a;
            if (
          ...
          if (
            ...
            for (var o in e.map) {
              ...
              if ("string" != typeof s) {
                ...
                l &&
                  ".js" == u.substr(u.length - 3, 3) &&
                  (u = u.substr(0, u.length - 3));
                var c = "";
                for (var f in n.packages)
                  u.substr(0, f.length) == f &&
                    (!u[f.length] || "/" == u[f.length]) &&
                    c.split("/").length < f.split("/").length &&
                    (c = f);
                c &&
                  n.packages[c].main &&
                  (u = u.substr(0, u.length - n.packages[c].main.length - 1));
            ...
            for (var o in e.bundles) {
              for (var x = [], p = 0; p < e.bundles[o].length; p++) {
                var l =
                    ...
                    ".js" !=
                      e.bundles[o][p].substr(e.bundles[o][p].length - 3, 3),
          ...
          for (var j in e) {
            ...
            if (
              ...
              if ("object" != typeof s || s instanceof Array) n[j] = s;
              else {
                n[j] = n[j] || {};
                for (var o in s)
                  if ("meta" == j && "*" == o[0])
              ...
              return (
                r.map &&
                  ...
                  s ||
                    ((i = "./" + t(e, r, n, a, o)),
                    i != "./" + a && (s = S(r.map, i)))),
                (s ? d(e, r, n, s, i, o) : Promise.resolve()).then(function (
                  i
                ) {
                  return i
                    ? Promise.resolve(i)
                    ...
                    Promise.resolve()
                      ...
                      .then(function (i) {
                        ...
                        var p = o.packages[c],
                          h = p && (p.configured || !d);
                        return (
                          h ? Promise.resolve(p) : m(o, c, d.configPath)
                        ).then(function (e) {
              ...
              for (var a = 0, o = e.normalizedDeps.length; o > a; a++) {
                ...
                if (s && !s.evaluated) {
                  ...
                  if (null === s.groupIndex || s.groupIndex < l) {
                    if (
                      null !== s.groupIndex &&
                      (n[s.groupIndex].splice(U.call(n[s.groupIndex], s), 1),
            ...
            if (!t.module) {
              ...
              var f = t.execute.call(
                ...
                function (e) {
                  ...
                  if (-1 != U.call(t.normalizedDeps, o)) return d(o, n);
                  throw new Error(
              ...
              f && (o.exports = f),
                ...
                a && (a.__esModule || a instanceof r)
                  ...
                  : (t.esModule = n.newModule({ default: a }));
            }
          }
          function f(t, r, n, a) {
            ...
            i("instantiate", function (e) {
              return function (t) {
                ...
                if (a.defined[t.name])
                  ...
                  if (
                    ("undefined" != typeof te && te.call(a, t),
            ...
            i("translate", function (a) {
              return function (o) {
                ...
                return a.apply(i, s).then(function (a) {
                  if (
                    "esm" == o.metadata.format ||
                    "es6" == o.metadata.format ||
                    (!o.metadata.format && a.match(t))
                  ) {
                    if (
                      ("es6" == o.metadata.format &&
                        w.call(
                    ...
                    return (
                      (i._loader.loadedTranspiler =
                        i._loader.loadedTranspiler || !1),
                      i.pluginLoader &&
                        (i.pluginLoader._loader.loadedTranspiler =
                          i._loader.loadedTranspiler || !1),
                      (
                        i._loader.transpilerPromise ||
                        (i._loader.transpilerPromise = Promise.resolve(
                          e[
                            "typescript" == i.transpiler ? "ts" : i.transpiler
                          ] || (i.pluginLoader || i)["import"](i.transpiler)
                        ))
                      ).then(function (e) {
                        return (
                          (i._loader.loadedTranspilerRuntime = !0),
                          e.translate
                            ? e == o.metadata.loaderModule
                              ? o.source
                              : ("string" == typeof o.metadata.sourceMap &&
                                  (o.metadata.sourceMap = JSON.parse(
                                    o.metadata.sourceMap
                                  )),
                                Promise.resolve(e.translate.apply(i, s)).then(
                                  function (e) {
                                    var t = o.metadata.sourceMap;
                                    if (t && "object" == typeof t) {
                                      var r = o.address.split("!")[0];
                                      (t.file && t.file != o.address) ||
                                        (t.file = r + "!transpiled"),
                                        (!t.sources ||
                                          (t.sources.length <= 1 &&
                                            (!t.sources[0] ||
                                              t.sources[0] == o.address))) &&
                                          (t.sources = [r]);
                                    }
                                    return (
                                      "esm" == o.metadata.format &&
                                        !i.builder &&
                                        O(e) &&
                                        (o.metadata.format = "register"),
                                      e
                                    );
                                  }
                                ))
                            : (i.builder &&
                                (o.metadata.originalSource = o.source),
                              V.call(i, o).then(function (e) {
                  ...
                  if (
                    (i._loader.loadedTranspiler !== !1 ||
                      ("traceur" != i.transpiler &&
                        "typescript" != i.transpiler &&
                        "babel" != i.transpiler) ||
                      o.name != i.normalizeSync(i.transpiler) ||
                      (a.length > 100 &&
                        !o.metadata.format &&
                        ((o.metadata.format = "global"),
                        "traceur" === i.transpiler &&
                          (o.metadata.exports = "traceur"),
                        "typescript" === i.transpiler &&
                          (o.metadata.exports = "ts")),
                      (i._loader.loadedTranspiler = !0)),
                    i._loader.loadedTranspilerRuntime === !1 &&
                      (o.name == i.normalizeSync("traceur-runtime") ||
                        o.name == i.normalizeSync("babel/external-helpers*")) &&
                      (a.length > 100 &&
                        (o.metadata.format = o.metadata.format || "global"),
                      (i._loader.loadedTranspilerRuntime = !0)),
                    ("register" == o.metadata.format || o.metadata.bundle) &&
                      i._loader.loadedTranspilerRuntime !== !0)
                  ) {
                    if (
                      "traceur" == i.transpiler &&
                      ...
                      return (
                        (i._loader.loadedTranspilerRuntime =
                          i._loader.loadedTranspilerRuntime || !1),
                        i["import"]("traceur-runtime").then(function () {
                          return a;
                        })
                      );
                    if (
                      ...
                      return (
                        (i._loader.loadedTranspilerRuntime =
                          i._loader.loadedTranspilerRuntime || !1),
                        i["import"]("babel/external-helpers").then(function () {
                          return a;
                        })
                      );
                  }
        ...
        i("fetch", function (e) {
          ...
          i("reduceRegister_", function (e) {
            return function (t, r) {
              if (
                r ||
                (!t.metadata.exports && (!A || "global" != t.metadata.format))
              )
          ...
          i("fetch", function (t) {
            return function (r) {
              return (
                r.metadata.scriptLoad && F && (e.define = this.amdDefine),
                t.call(this, r)
              );
            };
          }),
          s(function (t) {
            return function () {
              ...
              function a(t, a, i) {
                ...
                var l, u, d;
                -1 != (l = U.call(a, "require")) &&
                  (a.splice(l, 1), t || (a = a.concat(r(i.toString(), l)))),
                  -1 != (u = U.call(a, "exports")) && a.splice(u, 1),
                  -1 != (d = U.call(a, "module")) && a.splice(d, 1);
                var c = M();
          ...
          (function () {
            ...
            function a(a) {
              return function (o, i, s) {
                var l = this,
                  u = t(l, o);
                if (((i = e(this, i)), !u)) return a.call(this, o, i, s);
              ...
              i("instantiate", function (e) {
                return function (t) {
                  var r = this,
                    n = !1;
                  return t.metadata.loaderModule &&
                    t.metadata.loaderModule.instantiate &&
                    !r.builder &&
                    "defined" != t.metadata.format
                    ? Promise.resolve(
                        t.metadata.loaderModule.instantiate.call(
                          r,
                          t,
                          function (t) {
                            if (n)
